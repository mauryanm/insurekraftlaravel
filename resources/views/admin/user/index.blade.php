        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Users</h4><a href="{{ route('admin.users.create') }}" class="btn btn-rounded btn-info"><span class="btn-icon-start text-info"><i class="fa fa-plus color-info"></i>
                    </span>Add</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-responsive-md">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><div class="d-flex align-items-center"><img src="{{ URL::to('assets/images/avatar/1.jpg') }}" class="rounded-lg me-2" width="24" alt=""> <span class="w-space-no">{{$user->name}}</span></div></td>
                                    <td>{{$user->email}}</td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            {{-- <a onclick="delete({{$user->id}})" href="{{ route('admin.users.destroy', $user->id)}}" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a> --}}
